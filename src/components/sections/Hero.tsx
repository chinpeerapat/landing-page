...
export default function Hero() {
  ...
  return (
    <section className="pt-32 pb-20 overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="container mx-auto px-6">
        <div className="relative">
          ...
          <div ref={ref} className={`relative max-w-5xl mx-auto text-center fade-in-section ${isVisible ? 'is-visible' : ''}`}>
            <h1 className="mt-6 text-5xl md:text-6xl font-bold leading-tight mb-8 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
              {t('hero.title')}
            </h1>
